    ...
    phases = [
        PhaseSpec(
            ...
            system_prompt_override=(
                ...
                "The generated runner must use ask_user for material ambiguity. If it "
                "returns timed_out=true, make a safest best-effort decision, record the "
                "assumption, and do not pretend the user answered; timeout is not a "
                "phase transition and generated runners must not implement their own "
                "question timers. The complete read-only self-inspection surface is "
