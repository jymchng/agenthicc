...
def test_plugin_in_cycle_reachable_from_debug(tmp_path):
    ...
    # Extra is appended after Yolo; cycling from Yolo should reach Extra
    assert reg.next_after("Yolo").name == "Extra"
    # And Extra wraps back to Safe
    assert reg.next_after("Extra").name == "Safe"
